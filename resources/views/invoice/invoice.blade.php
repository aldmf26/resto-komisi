                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table  " id="table" width="100%" style="font-size: 12px;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th rowspan="2" style="font-size: 12px;">Subtotal</th>
                                    ...
                                    foreach ($invoice as $inv) : ?>
                                            <tr>
                                                ...
                                                <td><?= $inv->nm_meja ?></td>
                                                <td>
                                                    <?php if($inv->total_orderan - $inv->voucher - $inv->discount < 0): ?>
                                                    0
                                                    <?php else: ?>
                                                    <?= number_format($inv->total_orderan - $inv->voucher - $inv->discount , 0) ?>
                                                    <?php endif ?>
